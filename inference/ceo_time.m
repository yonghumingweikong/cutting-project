function [X_opt, y_opt, time, flag] = ceo_time(f, l, u, options, g, gamma, reference, actual, Ts)
...
%
   ...
   while 1
      ...
      if (strcmpi(display, 'iter'))
         ...
         y_latest = ADRC_rollout(X_opt(1),X_opt(2),X_opt(3),X_opt(4),X_opt(5),X_opt(6),reference,Ts);
