function [X_opt, y_opt, time, flag] = ceo_disturbance_tf(f, l, u, options, g, gamma, reference, actual, Ts, d)
...
%
   ...
   while 1
      ...
      if (strcmpi(display, 'iter'))
         ...
         y_latest = ADRC_TF_disturbance_rollout(X_opt(1),X_opt(2),X_opt(3),X_opt(4),X_opt(5),X_opt(6),X_opt(7),X_opt(8),reference,Ts,d);
