function [X_opt, y_opt, time, flag] = ceo_pulse3(f, l, u, options, g, gamma, M, actual, Ts)
...
%
   ...
   while 1
      ...
      if (strcmpi(display, 'iter'))
         ...
         y_latest = pulse_rollout3(X_opt(1),X_opt(2),X_opt(3),X_opt(4), ... 
         ...
         Pulse = pulse3(X_opt,180); plot(Pulse,'-.'); pause(0.1);
      end      
      if (t >= N)
