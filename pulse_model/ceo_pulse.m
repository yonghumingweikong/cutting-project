function [X_opt, y_opt, time, flag] = ceo_pulse(f, l, u, options, g, gamma, M, actual, Ts)
...
%
   ...
   while 1
      ...
      if (strcmpi(display, 'iter'))
         ...
         y_latest = pulse_rollout(X_opt(1),X_opt(2),X_opt(3),X_opt(4), ... 
             X_opt(5),X_opt(6),X_opt(7),X_opt(8), ...
             X_opt(9),X_opt(10),X_opt(11),X_opt(12),X_opt(13),X_opt(14),M,Ts);
